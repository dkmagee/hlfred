...
#
# $Id: sextractor.py,v 1.7 2007/09/04 09:44:12 llg Exp $
#
# ======================================================================
#
...
version: 0.1.8 - last modified: 2010-06-17
...
class SExtractor:
    ...
    _SE_config = { 
        ...
        {"comment": 'Array to put in the FILTER_MASK file',
         "value": [[0.109853, 0.300700, 0.109853],
    ...
    def setup(self, path=None):
        ...
        for candidate in candidates:
            try:
                p = Popen(candidate, stdout=PIPE, stderr=PIPE)
                stdout, stderr = p.communicate()
                versionline = str(stderr)
